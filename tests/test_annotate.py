...
def test_circos_group(dummyG):
    ...
    nv.circos(dummyG, group_by="group")
...
def test_parallel_group(dummyG):
    ...
    nv.parallel(dummyG, group_by="group")
...
def test_matrix_group(dummyG):
    ...
    nv.matrix(dummyG, group_by="group")
...
def test_matrix_block(dummyG):
    ...
    nv.matrix(dummyG, group_by="group", node_color_by="group")
...
def test_node_colormapping(dummyG):
    ...
    nv.circos(dummyG, group_by="group", node_color_by="group")
...
def test_node_colormapping_node_palette(manygroupG, tab20):
    ...
    with pytest.raises(ValueError):
        nv.circos(manygroupG, group_by="group", node_color_by="group")
        annotate.node_colormapping(manygroupG, color_by="group")

    nv.circos(manygroupG, group_by="group", node_color_by="group", node_palette=tab20)
    ...
    nv.circos(manygroupG, group_by="group", node_color_by="group", node_palette=paldict)
...
def test_edge_colormapping(dummyG):
    ...
    nv.circos(dummyG, group_by="group", edge_color_by="edge_value")
