...
def load_crime_network():
    df = pd.read_csv(curr_path + '/moreno_crime/out.moreno_crime_crime',
...
c = CircosPlot(pG, node_grouping='gender', node_order='connectivity',
               node_color='gender')
c.draw()
plt.show()
